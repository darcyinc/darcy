  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 mt-2 w-full">
        <div>
          <label
            ...
            className='input border input-bordered flex items-center gap-2 data-[invalid="true"]:!input-error data-[invalid="false"]:!input-success'
          >
      ...
      <div className="flex flex-col gap-2">
        ...
        <p>
          {t.rich('Footer.NewUser', {
            link: (chunks) => (
              <Link className="link link-accent link-hover" href="/auth/signup">
                {chunks}
              </Link>
            )
          })}
