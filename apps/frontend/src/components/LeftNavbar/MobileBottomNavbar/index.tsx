...
export default function MobileBottomNavbar() {
  return (
    <footer className="fixed bottom-0 left-0 flex h-14 w-full items-center justify-around border-t border-grayBorder bg-background/80 px-6 py-2 backdrop-blur-sm md:justify-between">
