...
export default function NavbarProfile() {
  return (
    <Link
      className="mt-auto flex items-center justify-center gap-3 rounded-full text-textPrimary hover:bg-hoverEffect hover:no-underline focus:bg-hoverEffect focus:no-underline xl:p-3"
      href="/davipatricio"
    >
